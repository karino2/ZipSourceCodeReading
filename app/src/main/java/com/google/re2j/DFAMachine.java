...
class DFAMachine implements Machine {
  ...
  private void setDfaThreadLocal(final MatchKind matchKind, final boolean reversed) {
    final int dfaKey = dfaKey(matchKind, reversed);
    final Prog prog = reversed ? re2.reverseProg : re2.prog;
